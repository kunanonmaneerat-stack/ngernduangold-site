# Post Queue — ตารางคิวโพสต์ (จาก post_timing + ดราฟต์ล่าสุด) 20260817-0704
...
## BLOCKED
- knowledge validation failed: kn-30: relevant official source review is pending: bot-mobile-app, bot-mobile-app-launch
