# Traffic Analyst — decision safety (20260816-1251)
...
- GA4 Decision Trust=UNTRUSTED — bundle=UNTRUSTED_AT_CAPTURE; capture=UNTRUSTED; current=UNTRUSTED
- observed affiliate_click distribution (ไม่ใช่อันดับรายได้): pantip (4 affiliate_click / 14 sessions), chatgpt (2 affiliate_click / 12 sessions)
...
- **verified net revenue**: 0 บาท · confirmed sales=0 · confirmed affiliate commission=0
- diagnostic rates: affiliate_click/session=5.9% · quiz_start/session=0.0%
