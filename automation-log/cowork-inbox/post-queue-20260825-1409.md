# Post Queue — ตารางคิวโพสต์ (จาก post_timing + ดราฟต์ล่าสุด) 20260825-1409
...
## BLOCKED
- knowledge validation failed: kn-29 line 7 facebook: comply gate: GATE_FAIL duplicate-text (fb): permanent dedup identity coverage is INCOMPLETE (36 c
