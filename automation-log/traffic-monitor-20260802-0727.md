# Traffic Monitor — สัญญาณรายช่อง (20260802-0727)
...
## GA4 (จริง)
funnel: quiz_start=1 -> quiz_complete=1 -> recommendation_view=1 -> affiliate_click=9
