...
_แก้ล่าสุด 25 ก.ค. 2026 (loop-architect): rich menu ยืนยัน live · เพิ่มแถว ปลายทางฟันเนล + หลักการข้อ 4_
...
4. **ตรวจปลายทาง ไม่ใช่แค่ต้นทาง** (บทเรียน 25 ก.ค. 2026) — พบแชท LINE OA ถูกปิดอยู่ = ขายไม่ได้เลย ทั้งที่โพสต์/SEO/เว็บ ปกติ · ทุก surface ที่จบด้วย "ให้คนทัก/กดซื้อ" ต้องมีเวรตรวจว่าปลายทางรับสายจริง ไม่ใช่ดูแค่ traffic
...
| LINE OA | rich menu (เมนูลิงก์ถาวร) | ✅ ตรวจแล้ว 25 ก.ค. — live อยู่แล้ว ("เมนูหลัก" 3 ปุ่ม + UTM ครบ) ไม่ต้องสร้างใหม่ | — |
...
| ฟันเนล/ขาย | ปลายทาง LINE OA รับสายได้จริง (แชท/auto-reply/rich menu/friends) + หน้าเงิน | ✅ เปิดใช้ 25 ก.ค. | task ngernduangold-funnel-endpoint-check พุธ 09:40 (อ่านอย่างเดียว ห้ามแก้) |
