# Traffic Monitor — สัญญาณรายช่อง (20260806-0722)
...
## GA4 (จริง)
funnel: quiz_start=1 -> quiz_complete=1 -> recommendation_view=1 -> affiliate_click=7
...
| / | 150 | 0 |
| /links | 26 | 0 |
| /debt-letter-kit | 14 | 0 |
| /bureau-blacklist-loan-2026 | 12 | 0 |
| /debt-calculator | 10 | 0 |
| /debt-clinic-sam-2026 | 7 | 0 |
| /debt-health-check | 6 | 0 |
| /debt-freedom-clock | 5 | 0 |
