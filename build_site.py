...
{cta('Srisawad',SRISAWAD,'title-loan','จำนำทะเบียน ศรีสวัสดิ์ เงินสดทันใจ รถยังใช้ได้ 👉')}
...
{cta('Srisawad',SRISAWAD,'title-loan','เช็กวงเงินจำนำทะเบียนรถ (ฟรี ไม่มีค่าใช้จ่าย) 👉')}
<p style="text-align:center;color:#5b5b66;font-size:14px">ทางเลือกอื่นเทียบดู: <a rel="sponsored noopener nofollow" target="_blank" href="{utm(CAR4CASH,'Car4Cash','title-loan')}">Car4Cash รถแลกเงิน</a> · <a rel="sponsored noopener nofollow" target="_blank" href="{utm(KTCPBM,'KTCpheboom','title-loan')}">KTC พี่เบิ้ม รถแลกเงิน</a></p>
