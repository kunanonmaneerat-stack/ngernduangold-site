...
header.top .logo{width:26px;height:26px;border-radius:6px;background:var(--gold)}
...
<header class="top"><div class="wrap"><span class="logo"></span><b>{SITE}</b>
<nav><a href="/">หน้าแรก</a><a href="/about.html">เกี่ยวกับเรา</a><a href="/disclaimer.html">นโยบาย</a></nav></div></header>"""
...
for slug,title,desc,body,faqs,camp in ART:
    ...
    open(f"{OUT}/{slug}","w",encoding="utf-8").write(head(title,desc,slug,ld,og_image=_ogimg)+f'<main class="wrap">{body}{_nav}</main>'+FOOTER)
...
# sitemap + robots
urls=[("",("1.0")),("links","0.9"),("about.html","0.4"),("disclaimer.html","0.3")]+[(s,"0.8") for s,*_ in ART]
