...
VALUE = {
  ...
  "vid_titleloan":"มีรถปลอดภาระ อยากได้เงินก้อนแต่ยังใช้รถได้ จำนำทะเบียนเป็นทางเลือก\nเทียบดอกเบี้ย/วงเงินหลายเจ้าก่อนเซ็น กู้เท่าที่จำเป็น",
  "vid_track":    "จดรายรับรายจ่ายช่วยให้เห็นว่าเงินรั่วตรงไหน\nเริ่มจากจดสั้น ๆ ไม่กี่วัน แล้วตัดรายจ่ายที่ไม่จำเป็นออก",
}
HASH = {
  ...
  "vid_titleloan": ["#จำนำทะเบียน", "#สินเชื่อ", "#เงินด่วน"],
  "vid_track": ["#จดรายรับรายจ่าย", "#วางแผนการเงิน", "#ออมเงิน"],
}
